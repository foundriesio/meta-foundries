...
| [`packagegroup-fio-ota`](../recipes-sota/packagegroups/packagegroup-fio-ota.bb) | — | Installs the update client, the compose-app manager, and the registration tool together |
