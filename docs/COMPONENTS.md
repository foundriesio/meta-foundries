...
| [`packagegroup-fio-ota`](../recipes-sota/packagegroups/packagegroup-fio-ota.bb) | — | Installs the update client, the registration tool, the configuration daemon, and, unless `COMPOSE_APP_MANAGER` is empty, the compose-app manager |
